...
@pytest.mark.usefixtures("login_mss_an_heng_cloud")
class TestDataSubscription(object):
    ...
    def test_an_heng_cloud_report(self, login_mss_an_heng_cloud):
        """
        人读报告-应急漏洞报告发送
        :param login_mss_an_heng_cloud: token值
        :return:
        """
        date = {
            "update_time": 1655271760000,
        ...
        # 获取接口请求数据
        api_date = to_obtain_url_param_method(saas_type='AN_HENG_CLOUD', api_name='emergency_vulnerability_report', api='api', token=login_mss_an_heng_cloud)
        try:
